...
module.exports = class player {
  constructor(data) {
    ...
    this.tournament = [
      this.tournament_start_time,
      this.tournament_end_time,
      2,
      0,
      0,
      10,
    ...
    this.mobile_fox = 0;
    this.mobile_bee =
      data.gm; /* ================ [MOBIL PARA GM & RANK SPECIAL] ================ */
    this.random_mobil = 0;
    ...
    this.lastturn = 0;
    this.mobile =
      Types.MOBILE.ARMOR; /*Poner El Mobil Que Quieres Que Salga Para Todos*/
    this.is_ready = 0;
    this.is_master = 0;
    this.is_alive = !0;
    this.look = 0;
    ...
    if (sumtotal > 0) this.win_rate = Math.round((this.win * 100) / sumtotal);
  ...
  setAvatar(itm) {
    if (itm !== null && itm.length > 0) {
      let stats = itm[6];
      this.avaDelayOne =
        this.avaDelayOne + stats.stat_time > 50
          ? 50
          : this.avaDelayOne + stats.stat_time;
      this.avaDelayTwo =
        this.avaDelayTwo + stats.stat_item > 50
          ? 50
          : this.avaDelayTwo + stats.stat_item;
      this.avaGold =
        this.avaGold + stats.stat_pop > 50 ? 50 : this.avaGold + stats.stat_pop;
      this.avaScratch =
        this.avaScratch + stats.stat_dig > 50
          ? 50
          : this.avaScratch + stats.stat_dig;
      this.avaLife =
        this.avaLife + stats.stat_life > 50
          ? 50
          : this.avaLife + stats.stat_life;
      this.avaGuard =
        this.avaGuard + stats.stat_def > 50
          ? 50
          : this.avaGuard + stats.stat_def;
      this.avaAttack =
        this.avaAttack + stats.stat_atk > 50
          ? 50
          : this.avaAttack + stats.stat_atk;
      this.avaShieldRegen =
        this.avaShieldRegen + stats.stat_shld > 50
          ? 50
          : this.avaShieldRegen + stats.stat_shld;
    }
  }
